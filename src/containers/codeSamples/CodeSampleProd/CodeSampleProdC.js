...
class CodeSampleProd extends Component {

  componentDidMount() {
    console.log('>>>>>>>>>>>>>>>> CodeSampleProd > componentDidMount() <<<<<<<<<<<<<<<<<<<<<<');
  }

  componentWillUnmount() {
    console.log('>>>>>>>>>>>>>>>> CodeSampleProd > componentWillUnmount() <<<<<<<<<<<<<<');
  }
